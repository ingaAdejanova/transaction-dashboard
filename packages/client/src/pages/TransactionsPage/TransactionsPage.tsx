...
import { useFetchPagination, PaginationResult } from '../../hooks/useFetchPagination'
...
const TransactionsPage = () => {
  ...
  const {
    ...
    error,
    loadMoreItems,
  }: PaginationResult<Transaction> = useFetchPagination({ url: API_URL.TRANSACTIONS, filters })
