...
import { User } from '@finmid/lib-common/types/User'
...
export const fetchCurrentUserSuccess = (user: User) => ({ type: FETCH_CURRENT_USER_SUCCESS, payload: user })
export const fetchCurrentUserFailure = (error: string) => ({ type: FETCH_CURRENT_USER_FAILURE, payload: error })

export const fetchCurrentUser = () => async (dispatch: Dispatch<UsersActionTypes>) => {
